...
from .views import  list_schedule, add_schedule, get_all_schedule, get_monday_schedule, get_tuesday_schedule, get_wednesday_schedule, get_thursday_schedule, get_friday_schedule, get_saturday_schedule, get_sunday_schedule
...
urlpatterns = [
    ...
    path('get-all-schedule/', get_all_schedule, name='get_all_schedule'),
